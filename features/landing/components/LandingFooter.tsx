    ...
    <footer className="border-t border-border bg-card py-10">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 md:flex-row">
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-logo bg-primary text-primary-foreground font-heading text-body font-bold">
            P
          </div>
      ...
      <div className="mx-auto mt-6 max-w-6xl px-4 text-center text-label-sm text-muted-light">
