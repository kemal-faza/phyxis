...
export function CTASection() {
  return (
    <section className="bg-background py-16 md:py-24">
      <LandingContainer>
        <div className="relative overflow-hidden rounded-[26px] bg-gradient-to-b from-primary via-purple to-[#1a3fad] px-6 py-14 text-center md:px-12 md:py-16">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <Button className="bg-white text-primary hover:bg-white/90" href="/login">Enter workspace</Button>
