...
export function CTASection() {
	return (
		<section className="bg-background py-16 md:py-24">
			<LandingContainer>
				<div className="relative overflow-hidden rounded-[26px] bg-gradient-to-br from-primary via-purple to-[#1a3fad] px-6 py-14 text-center shadow-btn-primary md:px-12 md:py-16">
					<h2 className="font-heading text-headline-lg font-bold text-white">
						Ready to modernise your physics laboratory?
					</h2>
					<p className="mx-auto mt-4 max-w-xl text-white/80">
						Provision a demo tenant in minutes. Load one of our 20
