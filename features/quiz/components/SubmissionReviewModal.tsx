...
export function SubmissionReviewModal({
	...
	return (
		<Dialog
			...
			<DialogContent className="w-[calc(100%-2rem)] max-h-[80vh] max-w-lg overflow-y-auto md:max-w-2xl">
				<div className="mb-4 flex items-center justify-between">
					<div>
						...
						<p className="text-body-sm text-muted">
							{submission.nim} &mdash; {submission.topic}
						</p>
					</div>
					<Badge
				...
				<div className="mt-4 grid grid-cols-2 gap-3 md:grid-cols-4">
					{Object.entries(submission.criteriaScores).map(
						([criteria, score]) => (
							<Card
								key={criteria}
				...
				<div className="mt-6 space-y-3">
					<div className="text-headline-md font-bold">
						Final: {submission.finalScore}/100
					</div>
